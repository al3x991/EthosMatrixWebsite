...
<div className="p-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5">
{/* <!--Card 1--> */}
<div className="rounded overflow-hidden shadow-lg">
<div className=" relative h-80">
<Image  src="/assets/images/blog1.webp" fill sizes={'(max-width: 1250px) 100vw, 1250px'} style={{objectFit:"cover"}}  alt="Blog Post 1"/>
</div>
<div className="px-6 py-4">
<div className="font-bold text-xl mb-2">Designing Sustainable Homes: A Guide to Eco-Friendly Living</div>
...
<div className="rounded overflow-hidden shadow-lg">
<div className=" relative h-80">
<Image  src="/assets/images/blog2.webp" fill sizes={'(max-width: 1250px) 100vw, 1250px'} style={{objectFit:"cover"}}  alt="Blog Post 2"/>
</div>
<div className="px-6 py-4">
<div className="font-bold text-xl mb-2">Unlocking the Power of Renovation: Transforming Spaces, Enriching Lives</div>
<p className="text-gray-700 text-base">
...
{/* <!--Card 3--> */}
<div className="rounded overflow-hidden shadow-lg hidden xl:block">
<div className=" relative h-80">
<Image  src="/assets/images/blog3.webp" fill sizes={'(max-width: 1250px) 100vw, 1250px'} style={{objectFit:"cover"}}  alt="Blog Post 3"/>
</div>
<div className="px-6 py-4">
<div className="font-bold text-xl mb-2">The Blueprint of Architectural Brilliance: Unveiling the Art of Design</div>
<p className="text-gray-700 text-base">
